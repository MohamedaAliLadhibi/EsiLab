...
type ProductCardProps = Pick<Product, 'slug' | 'brand' | 'name' | 'category' | 'image' | 'excerpt'>;
    ...
    <article className="overflow-hidden rounded-[2rem] border border-line/80 bg-white shadow-soft transition duration-300 hover:-translate-y-1 hover:shadow-halo">
      ...
      <div className="border-t border-line/70 p-6">
        ...
        <div className="mt-6 flex items-center gap-3">
          <button
            type="button"
            className="inline-flex h-12 w-12 items-center justify-center rounded-xl border border-blue/25 text-blue transition hover:bg-blue hover:text-white"
